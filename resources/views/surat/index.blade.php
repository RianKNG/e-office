...
@endif
        ...
        <div class="row">
           ...
           <!-- Ganti bagian nomor surat -->
        <div class="col-md-6 mb-3">
            <label class="form-label">Nomor Surat</label>
            <input type="text" class="form-control" id="nomorSurat" name="nomor_surat" readonly placeholder="Akan di-generate otomatis">
        ...
        <div class="form-group">
                <label for="diterima_oleh">Penerima</label>
