            ...
            <form id="addItemForm" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">Nomor surat akan di-generate otomatis berdasarkan tanggal.</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="perihal" id="perihal" rows="2"></textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="isi_nota" id="isi_nota" rows="4"></textarea>
                    ...
                    <!-- Penulis (readonly preview, tidak dikirim) -->
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="approved_by" id="approved_by">
